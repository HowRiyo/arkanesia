    ...
    return (
        <main className="py-5 px-30">
            ...
            <section className="mt-20">
                <h3 className="text-3xl font-bold text-[var(--dark-col)]">Most Picked</h3>
                ...
                <div className="grid grid-cols-3 gap-8 mt-4">
                    <div className="relative col-span-1 rounded-lg shadow-md overflow-hidden hover-card">
                        <Link href="/login">
                            ...
                            <span className="absolute top-0 right-0 bg-[var(--main-col)] text-[var(--light-col)] px-8 py-1 rounded-bl-2xl font-semibold">Rp 300.000</span>
                        </Link>
                    </div>
                        ...
                        {[...Array(4)].map((_, i) => (
                            <div key={i} className="relative rounded-lg shadow-md overflow-hidden hover-card">
                                <Link href="/login">
                                    ...
                                    <span className="absolute top-0 right-0 bg-[var(--main-col)] text-[var(--light-col)] font-semibold px-8 py-1 rounded-bl-2xl">Rp 200.000</span>
                                    <div className="absolute w-full bottom-0 pb-2 pl-4 text-[var(--light-col)] mostPicked-card">
